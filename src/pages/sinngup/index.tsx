    ...
    return (
        <View style={styles.container}>
            ...
            onPress={()=> HandleLoginSession({email,password:senha})}
                style={styles.btn}>
                 <Title text={'Cadastrar'} style={{ color: '#fff', fontSize: 20, fontWeight: 'bold' }}></Title>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate("Singin" as unknown as never)}>
             <Title text={'Já possui cadastro?, Login'} style={{ color: '#fff', fontSize: 15, fontWeight: 'normal' }}></Title>
            </TouchableOpacity>
        </View>
    )
}
